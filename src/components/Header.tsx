...
const Header = () => {
  ...
  return (
    <header className={`sticky top-0 z-50 transition-all ${isScrolled ? 'bg-white shadow-md py-3' : 'bg-white py-4'}`}>
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center">
            <a href="/" className="flex items-center">
              <svg className="h-8 w-8 text-airbnb-red" viewBox="0 0 1000 1000" fill="currentColor">
              ...
              <span className="ml-2 text-airbnb-red font-bold text-2xl">airbnb</span>
            </a>
          </div>

          {/* Search bar */}
          <div className="hidden md:flex items-center justify-center flex-grow mx-6">
            <div className="flex items-center border rounded-full shadow-sm px-4 py-2 hover:shadow-md transition-shadow cursor-pointer">
              ...
              <Button className="rounded-full p-2 bg-airbnb-red hover:bg-airbnb-red/90 ml-3">
          ...
          {isMobile && (
            <div className="flex items-center border rounded-full shadow-sm p-2 ml-2 hover:shadow-md">
          ...
          {/* Right nav */}
          <div className="flex items-center">
            <a href="#" className="hidden md:block rounded-full px-4 py-2 hover:bg-gray-100 font-medium text-sm mr-2">
              Airbnb your home
            </a>
            
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="rounded-full border flex items-center gap-2 p-2 md:p-3 shadow-sm hover:shadow-md">
                  <div className="flex items-center">
