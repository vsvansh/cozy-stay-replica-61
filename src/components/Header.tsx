    ...
    <header className={cn(
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between">
          ...
          {isMobile && (
            <div className="flex items-center border rounded-full shadow-sm p-2 ml-2 hover:shadow-md transition-shadow duration-300">
          ...
          <div className="flex items-center space-x-4">
            <a href="#" className="hidden md:block rounded-full px-4 py-2 hover:bg-gray-100 font-medium text-sm transition-colors duration-200">
              Airbnb your home
            </a>
            ...
            <Popover>
              ...
              <PopoverContent className="w-56 p-0 animate-in fade-in-80 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:zoom-out-95" align="end">
                <div className="py-2">
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-100 transition-colors duration-200">Sign up</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-100 transition-colors duration-200">Log in</a>
                  <hr className="my-1" />
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-100 transition-colors duration-200">Airbnb your home</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-100 transition-colors duration-200">Help Center</a>
                </div>
              </PopoverContent>
            </Popover>
          </div>
